<template>
  <BaseForm @submit.prevent="handleSubmit" buttonText="Sign Up" :disableButton="v$.$error || v$.$errors.length > 0">
    ...
    <BaseInput v-model="state.phone" placeholder="Phone Number" :hasError="v$.phone.$error" :errors="v$.phone.$errors"
      id="phone" type="text" @blur="v$.phone.$touch"></BaseInput>
